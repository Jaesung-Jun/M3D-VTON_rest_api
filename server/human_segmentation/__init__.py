...
# Custom includes
from human_segmentation.networks import deeplab_xception_transfer, graph
from human_segmentation.dataloaders import custom_transforms as tr

#
import argparse
import torch.nn.functional as F
"""
label_colours = [(0,0,0)        # 배경
                , (128,0,0)     # 모자
                , (255,0,0)     # 머리카락
                , (0,85,0)      #
                , (170,0,51)    # 썬글라스
                , (5, 0, 0)    # 셔츠                  #, (255,85,0)    # 셔츠
                , (0,0,85)      # 드레스
                , (0,119,221)   # 코트
                , (85,85,0)     #
                , (0,85,85)     # 바지
                ...
                , (0,128,0)     #
                , (0,0,255)     # 얼굴
                , (14, 0, 0)  # 왼팔                  #, (51,170,221)  # 왼팔
                , (15, 0, 0)   # 오른팔                #, (0,255,255)   # 오른팔
                , (85,255,170)  # 왼다리
                , (170,255,85)  # 오른다리
                , (255,255,0)   # 왼신발
                , (255,170,0)   # 오른신발
...
def inference(net, img_path='', output_path='./', output_name='f', use_gpu=True):
    ...
    for epoch in range(1):
        ...
        print('The work ended in ' + str(end_time - start_time))

def run(output_path, output_name, img, load_model="./human_segmentation/pretrained/deeplabv3plus-xception-vocNov14_20-51-38_epoch-89.pth", use_gpu=1):
    '''argparse begin'''
    """
    ...
    """
    Can Cause Error in Windows System  because of os.path.basename(path)
    """
    ...
    inference(net=net, img_path=img, output_path=output_path, output_name=output_name, use_gpu=use_gpu)
    #ff = Image.open(img)
    #ff.save('./source.png')        

#run(img = "custom_model_.jpg", use_gpu=1, load_model="pretrained/deeplabv3plus-xception-vocNov14_20-51-38_epoch-89.pth")